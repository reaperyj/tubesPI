      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active" id="edit_forms">
          ...
          <ul class="treeview-menu">
            ...
            <li><a id="active" href="<?php echo base_url('admin/form_satuan')?>"><i class="fa fa-circle-o"></i> Tambah Satuan Barang</a></li>
          </ul>
        </li>
        ...
        <div class="col-md-12">
          ...
          <div class="box" style="width:94%;" id="box_forms">
            <div class="box-header with-border">
              <h3 class="box-title" style="font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Barang Masuk</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
                  ...
                  <?php foreach($data_satuan as $d){ ?>
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        ...
                        <label for="kode_satuan" style="width:87%;margin-left: 12px;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);">Kode Satuan</label>
                        <input type="text" required name="kode_satuan" style="width: 90%;margin-right: 67px;margin-left: 11px;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);" class="form-control" id="kode_satuan" placeholder="Kode Satuan" value="<?=$d->kode_satuan?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_satuan" style="width:73%;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);">Nama Satuan</label>
                        <input type="text" required name="nama_satuan" style="width:90%;margin-right: 67px;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);" class="form-control" id="nama_satuan" placeholder="Nama Satuan" value="<?=$d->nama_satuan?>">
                    </div>
                    <div class="form-group" style="display:inline-block;">
                      <button type="reset" id="button1" class="btn btn-basic" name="btn_reset" style="width:95px;margin-left:20px;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);"><i class="fa fa-eraser" aria-hidden="true"></i> Reset</button>
                    </div>
                    <?php } ?>
                    <!-- /.box-body -->

                    <div class="box-footer" style="width:93%;">
                      <a type="button" id="button2" class="btn btn-default" style="width:10%;margin-right:26%;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                      <a type="button" id="button3" class="btn btn-info" style="width:13%;margin-right:29%;font-family: 'Ubuntu', sans-serif;" href="<?=base_url('admin/tabel_satuan')?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Satuan</a>
                      <button type="submit" id="button4" style="width:20%" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
                    </div>
            </form>
          </div>
          </div>
