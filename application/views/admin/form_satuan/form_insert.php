        ...
        <div class="col-md-12">
          ...
          <div class="box" style="width:94%;" id="box_forms">
            <div class="box-header with-border">
              <h3 class="box-title" style="font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);""><i class="fa fa-archive" aria-hidden="true"></i> Tambah Satuan Barang</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="kode_satuan" style="width: 90%;margin-right: 67px;margin-left: 11px;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);" class="form-control" id="kode_satuan" placeholder="Kode Satuan">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="nama_satuan" style="width:73%;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);">Nama Satuan</label>
                  <input type="text" name="nama_satuan" style="width:90%;margin-right: 67px;font-family: 'Ubuntu', sans-serif;color:rgb(63, 63, 63);" class="form-control" id="nama_satuan" placeholder="Nama Satuan">
              </div>
              <div class="form-group" style="display:inline-block;">
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" id="button3" class="btn btn-info" style="width:13%;margin-right:29%" href="<?=base_url('admin/tabel_satuan')?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Satuan</a>
